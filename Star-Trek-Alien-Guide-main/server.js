...
const aliens = {
    ...
    'gorn': {
        ...
        'interestingFact': 'Extremely militaristic and driven to conquer, they also possess advanced scientific knowledge allowing for superior bio-weapons.' ,
...
app.listen(process.env.PORT || PORT, () =>{
    console.log('Server running, go catch it, etc.')
})